"""
Django settings for shoppls project.
...
SECRET_KEY = 'ct4qpz#i1%b%$b@m6axr$tn0(xf@w4*c01z6e8uz+wkv@m=h6y'
...
WSGI_APPLICATION = 'shoppls.wsgi.application'
